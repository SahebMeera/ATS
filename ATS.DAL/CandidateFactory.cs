...
namespace ATS.DAL
{
    public class CandidateFactory : AbstractFactory
    {
        #region     
        private readonly string InsertSPName = "usp_InsUpdCandidate";
        private readonly string UpdateSPName = "usp_InsUpdCandidate";
        private readonly string DeleteSPName = "usp_DeleteCandidate";
        private readonly string SelectSPName = "usp_GetCandidate";
        #endregion

          public CandidateFactory(string connString, IConfiguration config)
